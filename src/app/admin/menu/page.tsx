  ...
  return (
    <>
      <div className="admin-header-flex">
        ...
        <button className="btn-primary" style={{padding: '0.6rem 1.5rem', fontSize: '0.9rem', width: 'auto', flexShrink: 0}}>+ Yeni Ürün</button>
      </div>
                ...
                <tr key={item.id}>
                  ...
                  <td>
                    <div style={{display: 'flex', gap: '0.5rem'}}>
                      <button className="action-btn" style={{marginRight: 0}}>Düzenle</button>
                      <button className="action-btn" style={{borderColor: '#f44336', color: '#f44336', marginRight: 0}}>Sil</button>
                    </div>
                  </td>
                </tr>
              ))
